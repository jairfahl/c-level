...
-- [v3] Adicionados 5 frameworks complementares para Multi-Framework Selection
...
CREATE TABLE decisions (
  ...
  initial_hypothesis  TEXT,                                                  -- [v3] Anti-terceirização cognitiva
...
COMMENT ON COLUMN decisions.initial_hypothesis  IS '[v3] Hipótese registrada pelo CFO ANTES de ver a recomendação da IA. Previne viés de ancoragem.';
...
-- ============================================================
--  KNOWLEDGE DOCUMENTS  [v3 NOVA — Base de Conhecimento]
-- ============================================================
...
COMMENT ON TABLE knowledge_documents IS '[v3] Documentos regulatórios/políticas uploadeados para injeção no contexto LLM.';

CREATE INDEX idx_kd_domain_type_active ON knowledge_documents(financial_domain, decision_type, active);
